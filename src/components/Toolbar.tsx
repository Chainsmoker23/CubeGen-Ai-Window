...
const Toolbar: React.FC<ToolbarProps> = ({ onExport, onExplain, isExplaining, onUndo, onRedo, canUndo, canRedo, onFitToScreen, onGoToPlayground, canGoToPlayground, onSave, onLoad, onZoomIn, onZoomOut }) => {
    ...
    <div className="flex items-center space-x-2">
      ...
      {onZoomIn && onZoomOut && (
        <>
          ...
          <ToolbarButton onClick={onZoomIn} aria-label="Zoom In">
          ...
          <ToolbarButton onClick={onZoomOut} aria-label="Zoom Out">
      ...
      {
        onSave && (
          <ToolbarButton onClick={onSave} aria-label="Save Diagram">
      ...
      {
        onLoad && (
          <ToolbarButton onClick={onLoad} aria-label="Open Diagram">
